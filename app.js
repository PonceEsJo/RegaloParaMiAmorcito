let anniversary = "2024-06-06";
let anniversaryDate = new Date(anniversary);
let today = new Date();

// Funci�n para calcular la diferencia en a�os, meses y d�as
function dateDiff(startDate, endDate) {
    let years = endDate.getFullYear() - startDate.getFullYear();
    let months = endDate.getMonth() - startDate.getMonth();
    let days = endDate.getDate() - startDate.getDate();

    // Si los d�as son negativos, resta un mes y ajusta los d�as
    if (days < 0) {
        months--;
    ...
    // Si los meses son negativos, resta un a�o y ajusta los meses
    if (months < 0) {
        years--;
        months += 12;
    }
...
// Actualiza el contenido en la p�gina con los resultados correctos
